...
export function* searchMovie({payload}) {
    ...
    try {
        const param = '&s=' + payload.movieName;
        const results = yield call(apiCall, param, null, null, 'GET');
...
export function* searchMovieById ({payload}) {
    try {
        const param = '&i=' + payload.movieId;
        const movie = yield call(apiCall, param, null, null, 'GET');
